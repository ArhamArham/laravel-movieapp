...
<div class="movie-info border-b border-gray-800">
    <div class="container mx-auto flex px-4 py-16 flex-col md:flex-row">
        <div class="flex-none">
        ...
        <div class="md:ml-24">
            ...
            <div class="mt-12">
                ...
                <div class="flex mt-4">
                    ...
                    <div class="mr-8">
                        <div>{{$crew['name']}}</div>
                        <div class="text-small text-gray-400">{{$crew['job']}}</div>
                    </div>
                    @endforeach
            </div>
        </div>
           ...
           <div class="mt-8">
                <a href="{{route('actors.show',$cast['id'])}}">
                    <img src="{{'https://image.tmdb.org/t/p/w500/'.$cast['profile_path']}}"
                        class="hover:opacity-75 trasnsition ease-in-out duration-150" alt="">
                </a>
                <div class="mt-2">
